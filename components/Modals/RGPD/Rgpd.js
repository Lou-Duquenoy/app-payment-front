...
export default function Rgpd() {
  const { rgpd, setRgpd } = useContext(DataContext);
...
return (
  ...
  <div className={showModal ? styles.modalRGPD : styles.modalHidden}>
    <div>
      ...
      <a title="Logo Ozalentour" href="https://fr.ozalentour.com" className="sitebrandlogo">
        <img src="oza-logo-site.png" alt="Ozalentour"/>
        </a>
      </div>
      <div className={styles.contenurgpd}>
        <h2> L'utilisation des cookies chez Ozalentour.</h2>
